...
urlpatterns = [
    ...
    path('23_sessions/', session_list_23, name='session_list_23'),
    ...
    path('daily_winloss/', daily_winloss_chart, name='daily_winloss_chart'),
    path('profit_per_session/', profit_per_session_chart, name='profit_per_session_chart'),
